...
# Función para obtener rutas compatibles con PyInstaller
...
# Usar resource_path para las rutas de datos
DATA_DIR = resource_path('data')
LOCALIZATIONS_DIR = resource_path('localizations')

# Crear carpetas si no existen (solo en desarrollo, en EXE ya existen)
...
class DataManager:
    ...
    def load_dolls(cls):
        ...
        if cls._dolls is None:
            try:
                ...
                print(f"✅ dolls.json cargado: {len(cls._dolls)} personajes")
            except Exception as e:
    ...
    def load_weapons(cls):
        ...
        if cls._weapons is None:
            try:
                ...
                print(f"✅ weapons.json cargado: {len(cls._weapons)} armas")
            except Exception as e:
    ...
    def load_localization(cls, language=None):
        ...
        try:
            ...
            # Fallback a español
            if cls._current_language != "ES":
                print("🔄 Intentando cargar español como fallback...")
                cls._current_language = "ES"
